...
df <- read.csv("C:/Users/Marto/DataScience/futbol/data/df_america.csv") 
```
...
Se trata de un _dataframe_ que tiene 37209 observaciones, o "filas" y 14 variables, o "columnas".
...
Genial, tenemos partidos de todas las ligas principales de fútbol de América. Pero vemos que uno de los valores es "South America", filtremos para ver qué partidos son...

```{r, echo=TRUE, message=FALSE}
#Filtramos los prtidos que en la columna país deicen "South America" y contamos la cantidad para cada torneo

head(df %>% 
  filter(pais=="South America") %>% 
    count(torneo)) 
```
...
Bien. Ahora tenemos 34.222 partidos. Sigamos.
