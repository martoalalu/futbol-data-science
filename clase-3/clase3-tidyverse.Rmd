...
```{r}
transferencia_reducido <- select(club_name, player_name, club_involved_name, fee_cleaned)
...
#transferencias_filtrado <- filter(transferencias_espania_2019, transfer_movement!='in', fee_cleaned>1)
#radares_filtrado <- filter(transferencias_espania_2019, !(transfer_movement=='in') & fee_cleaned>1)
...
```{r}
jugadores_usados_espania <- read_csv('https://raw.githubusercontent.com/martoalalu/futbol-data-science/master/data/jugadores_usados_espania.csv?token=AHEEK2PA67Z37RP3DRQEVEC7FTEHO')
