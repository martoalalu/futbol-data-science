...
```{r}
jugadores_usados_espania <- read_csv('https://raw.githubusercontent.com/martoalalu/futbol-data-science/master/data/jugadores_usados_espania.csv?token=AHEEK2OLI2ENKGNCL52G5PC7FTDVO')


transferencias_completo <- left_join(transferencias_espania_2019, jugadores_usados_espania, by = "nombre_club")

View(transferencias_completo)
